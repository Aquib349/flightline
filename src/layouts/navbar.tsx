...
const Navbar = () => {
  return (
    <>
      <nav>
        <div className="main fixed w-full flex justify-around items-center h-20 px-10 bg-white/50 backdrop-blur-xs z-50">
          ...
          <div className="flex items-center gap-8">
            ...
            <img
              ...
              className="w-4 h-4 object-cover cursor-pointer"
            />
            <button className="uppercase oswald-400 text-[#0D2BFE] font-bold text-sm flex items-center gap-1 cursor-pointer">
              contact us <ChevronRight size={16} />
            </button>
            <button className="uppercase oswald-400 bg-[#0D2BFE] text-white py-2.5 px-4 rounded-md font-bold text-sm flex items-center cursor-pointer">
              schedule a demo
            </button>
          </div>
        </div>
